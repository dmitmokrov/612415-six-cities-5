...
import {getOffers, getCity, getSortType, getActiveCardId} from '../../../store/selectors';
...
const mapStateToProps = (state) => ({
  city: getCity(state),
  offers: getOffersBySortType(getOffersInCity(getOffers(state), getCity(state)), getSortType(state)),
